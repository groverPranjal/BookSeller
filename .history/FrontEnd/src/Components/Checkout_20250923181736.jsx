    ...
    return <div className="min-h-screen bg-gradient-to-br from-[#43c6ac] to-[#f8ffae] py-20">
        <div className="container mx-auto px-4 max-w-4xl">
            <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12 text-center">
                <div className="inline-flex item-center justify-center w-20 h-20 bg-green-100 rounded-full mb-6">
                    ...
                    <p className="text-gray-600 mb-8">
                        We've sent a confirmation email to <span className="font-medium">
                          {formData.email}
                        </span>.
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link to='/book' className="px-6 py-6 bg-gradient-to-r from-[#1a237e] to-[#43c6ac] text-white rounded-lg font-medium hover:opacity-90">
                Continue Shopping
                </Link>
                <Link to='/orders' className='px-6 py-3 bg-white border border-[#43c6ac] rounded-lg font-medium hover:bg-[#43c6ac]/10'>
                    ...
                    <form onSubmit={handleSubmit}>
                        <div className="mb-6">
                            ...
                            {formFields.map((row,rowIndex)=>(
                                <div key={rowIndex} className={`grid grid-cols-1 ${row.some((field)=>field.fullWidth?"":" md:grid-cols-2")} gap-4 ${rowIndex>0? 'mt-4':""}`}></div>
                            ))}
                        </div>
                    </form>
                </div>
